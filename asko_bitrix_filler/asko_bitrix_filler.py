...
BITRIX_FIELDS = {
    ...
    "registration_certificate_issue_date": "UF_CRM_1707623009859",
...
class DealData:
    ...
    registration_certificate_issue_date: str
...
def extract_deal(result, webhook: str | None = None):
    ...
    return DealData(
        ...
        registration_certificate_issue_date=str(result.get(BITRIX_FIELDS["registration_certificate_issue_date"]) or "").strip(),
